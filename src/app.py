...
activities = {
    ...
    "Basketball Club": {
        "description": "Pick-up games and skill development sessions",
    ...
    "Theater Group": {
        ...
        "schedule": "Wednesdays, 6:00 PM - 8:00 PM; Saturdays, 2:00 PM - 5:00 PM",
        "max_participants": 25,
        "participants": ["isabella@mergington.edu", "jack@mergington.edu"]
    },
    "Debate Team": {
        "description": "Practice debates and regional competitions",
        "schedule": "Tuesdays, 6:00 PM - 8:00 PM",
        "max_participants": 16,
        "participants": ["oliver@mergington.edu", "ava.r@mergington.edu"]
    },
    "Math Club": {
        "description": "Problem solving, math contests, and enrichment",
        "schedule": "Thursdays, 5:00 PM - 6:00 PM",
        "max_participants": 18,
        "participants": ["sophia.l@mergington.edu", "benjamin@mergington.edu"]
    }
}
